        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-foreground mb-4">
              Focused on What Matters: Building Camel Integrations
            </h3>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Free and open source. Cameleon gives you the tools to design,
              visualize, and export integrations — the community-driven way to
              build with Apache Camel.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Drag-and-drop to design Camel routes and integration patterns.
            ...
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle>Dual Editing</CardTitle>
                <CardDescription>
                  Switch between visual design and code editing seamlessly. Open
            ...
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle>Code & YAML Export</CardTitle>
                <CardDescription>
                  Generate Apache Camel Java DSL or YAML directly from
                  workflows. No locked-in formats.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Save workflows as presets and reuse integration patterns.
                  Community templates welcome!
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Share workflows with your team and the community. Open source
                  means better together.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-card/50 border-border/50 hover:bg-card/70 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle>Powered by Apache Camel</CardTitle>
                <CardDescription>
                  Work natively with the Camel ecosystem and EIP standards. Open
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Whether you're prototyping, documenting, or preparing
              production-ready routes, Cameleon accelerates the way you design
              with Camel - completely free and open source.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Quickly sketch and validate integration ideas visually. Free
                forever.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Create visual blueprints for integration projects and share with
                your team. No paywalls.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Export YAML or Java DSL to jump-start your production routes.
                Open format.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-card/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Cameleon is built by and for the Apache Camel community. Free to
              use, modify, and contribute to.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto bg-card p-8 rounded-xl border">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="https://github.com/jucian0/cameleon/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-6 text-sm text-muted-foreground">
              ...
              <a
                href="https://github.com/jucian0/cameleon/blob/main/LICENSE"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-foreground transition-colors"
              >
            ...
            <div className="text-sm text-muted-foreground">
              © 2024 Cameleon. Free and open source. Powered by Apache Camel.
            </div>
          </div>
        </div>
      </footer>
