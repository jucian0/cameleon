...
export default function CamelWorkflows() {
  ...
  const showListShell =
    location.pathname === "/app/camel/workflows" ||
    location.pathname === "/app/camel/workflows/create" ||
    location.pathname === "/app/camel/workflows/import";
  ...
  const filteredItems = showListShell
    ? filterItems(items ?? [], searchParams, currentUserId)
    : [];
