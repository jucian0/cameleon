...
//       ? `${window.location.origin}/camel-configs`
//       : "";
...
//         <h1 className="text-3xl font-bold tracking-tight">Camel Configs</h1>
//         <p className="text-muted-foreground">
//           Search, sort, and switch between card and list layouts.
//         </p>
//       </header>

//       <section aria-label="Toolbar" className="mb-6">
//         <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
//           <div className="flex items-center gap-2">
//             <div className="relative w-full sm:w-80">
//               <Search className="absolute left-2 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
//               <Input
//                 placeholder="Search configs, tags, owners..."
//                 value={query}
//                 onChange={(e) => setQuery(e.target.value)}
//                 className="pl-8"
//                 aria-label="Search Camel configs"
//               />
//             </div>
//             <Select
//               value={sort}
//               onValueChange={(v: "name" | "updatedAt") => setSort(v)}
//             >
//               <SelectTrigger className="w-40" aria-label="Sort by">
//                 <SelectValue placeholder="Sort by" />
//               </SelectTrigger>
//               <SelectContent>
//                 <SelectItem value="updatedAt">Recent first</SelectItem>
